...
def main():
    ...
    try:
        ...
        # Step 2: Center object VERTICALLY by adjusting arm extension
        # WHILE MAINTAINING PERPENDICULARITY
        print("\nSTAGE 2 Step 2: Centering object vertically (camera stays perpendicular)...")
